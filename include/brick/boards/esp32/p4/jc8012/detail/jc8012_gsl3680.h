...
inline touch::Gsl3680Config
jc8012_gsl3680(brick::interfaces::display::Rotation rotation = brick::interfaces::display::Rotation::rotate_0)
{
    touch::Gsl3680Config config;
    const bool swapped = rotation == brick::interfaces::display::Rotation::rotate_90 ||
                         rotation == brick::interfaces::display::Rotation::rotate_270;
    const bool mirrored_x = rotation == brick::interfaces::display::Rotation::rotate_0 ||
                            rotation == brick::interfaces::display::Rotation::rotate_270;
    const bool mirrored_y = rotation == brick::interfaces::display::Rotation::rotate_180 ||
                            rotation == brick::interfaces::display::Rotation::rotate_270;
